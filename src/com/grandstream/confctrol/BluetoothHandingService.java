...
public class BluetoothHandingService {
    ...
    public static final int STATE_CONNECT_FAIL = 4;  // now connecting  fail
    public static final int STATE_CONNECTED_LOST = 5;  // now connected lost.
     ...
     */
    public BluetoothHandingService(Context context, Handler handler) {
...
//        }
        ...
        LogUtils.printLog(TAG, "connect        state= "+getState());
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothHandingService.this) {
                        switch (mState) {
                            case STATE_LISTEN:
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    ...
                    LogUtils.printLog(TAG,"mmSocket.close()  >"+e2.getMessage());
                }
                LogUtils.printLog(TAG,"mmSocket.connect()  >"+e.getMessage());
                e.printStackTrace();
                connectionFailed();
                return;
            }
...
//                    BluetoothChatService.this.start();
        ...
        public void write(byte[] buffer) {
            try {
                ...
                //see LocalSocketImpl.SocketOutputStream.
                //Wait until the data in sending queue is emptied. A polling version for flush implementation.
                //mmOutStream.flush();
