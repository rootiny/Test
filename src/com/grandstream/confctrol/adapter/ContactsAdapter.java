package com.grandstream.confctrol.adapter;
...
public class ContactsAdapter extends BaseAdapter implements SectionIndexer,
    ...
    public ContactsAdapter( String[] datas, List<String> contactsSections,
                           List<Integer> friendsPositions, LayoutInflater inflater) {
//        this.mLocationPosition = locationposition;
        this.mDatas = datas;
        this.mFriendsSections = contactsSections;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.contact_fragment_spinlistview_item_layout, null);
        }
